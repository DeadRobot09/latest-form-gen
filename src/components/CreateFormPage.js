...
const CreateFormPage = () => {
  ...
  const [undoStack, setUndoStack] = useState([]); // Maintain a stack for undo operations
  ...
  const renderFormComponents = () => {
    return formData.components.map((component, componentIndex) => (
